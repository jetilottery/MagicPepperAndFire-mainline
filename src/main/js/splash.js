define(['skbJet/component/resourceLoader/resourceLib', 'skbJet/componentLIT/standardIW/splash/splashLoadController'], function(
  resLib,
  ...
  function onLoadSplashDone() {
    ...
    var loaderLogo = window.innerWidth > window.innerHeight ?
      resLib.splash.landscape_loaderimage :
      resLib.splash.portrait_loaderimage;

    loaderContainer.appendChild(loaderLogo);
    resLib.splash.landscape_loaderimage.className = 'loaderImage';
    resLib.splash.landscape_loaderimage.className = 'loaderImage';
