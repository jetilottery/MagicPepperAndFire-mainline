define(require => {
    ...
    let bigWinSettingsPepper = {
        animatedParticlePrefix: 'pepper_',
        startFrame: 1,
        endFrame: 30,
        isAnimated: true,
        nonAnimatedImages: [],
    ...
    function init() {
        ...
        //  if (app.stage.children[i].name === 'resultPlaquesContainer' /*'resultPlaquesContainer'*/ ) {
        //    app.stage.addChildAt(_container, i - 1);
        //  break;
        //}
        //}
        var gameContainer = app.stage.children[0];
    ...
    function initEmitters(inOrientation, inContainer, inConfig) {
        ...
        inContainer.emitter2 = utils.createEmitter(
            inContainer,
            inConfig,
            inConfig.bigWinSettingsPepper.animatedParticlePrefix,
            inConfig.bigWinSettingsPepper.nonAnimatedImages,
            inConfig.bigWinSettingsPepper.isAnimated, { startFrame: inConfig.bigWinSettingsPepper.startFrame, endFrame: inConfig.bigWinSettingsPepper.endFrame, isSingleNumFormat: true, frameRate: inConfig.bigWinSettingsPepper.frameRate }
        );
    ...
    function setProps(config) {
        // Kill both emitters
        if (_containerPortrait.emitter && _containerLandscape.emitter && _containerPortrait.emitter && _containerLandscape.emitter) {
            _containerPortrait.emitter.killEmitter();
            _containerLandscape.emitter.killEmitter();
            _containerPortrait.emitter2.killEmitter();
            _containerLandscape.emitter2.killEmitter();
        }
    ...
    function reconfigure(config, inOrientation) {
        ...
        // Set up big win
        newConfig.bigWinSettingsPepper = {};
        newConfig.bigWinSettingsPepper.animatedParticlePrefix = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('animatedParticlePrefix') ? gameConfig.bigWinSettingsPepper[inOrientation].animatedParticlePrefix : bigWinSettingsPepper.animatedParticlePrefix;
        newConfig.bigWinSettingsPepper.isAnimated = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('isAnimated') ? gameConfig.bigWinSettingsPepper[inOrientation].isAnimated : bigWinSettingsPepper.isAnimated;
        newConfig.bigWinSettingsPepper.startFrame = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('startFrame') ? gameConfig.bigWinSettingsPepper[inOrientation].startFrame : bigWinSettingsPepper.startFrame;
        newConfig.bigWinSettingsPepper.endFrame = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('endFrame') ? gameConfig.bigWinSettingsPepper[inOrientation].endFrame : bigWinSettingsPepper.endFrame;
        newConfig.bigWinSettingsPepper.nonAnimatedImages = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('nonAnimatedImages') ? gameConfig.bigWinSettingsPepper[inOrientation].nonAnimatedImages : bigWinSettingsPepper.nonAnimatedImages;
        newConfig.bigWinSettingsPepper.frameRate = gameConfig.bigWinSettingsPepper[inOrientation].hasOwnProperty('frameRate') ? gameConfig.bigWinSettingsPepper[inOrientation].frameRate : bigWinSettingsPepper.frameRate;
    ...
    function toggleCoinShower(inVal) {
        ...
        //run all emitters
        if (_containerPortrait.emitter && _containerLandscape.emitter && _containerPortrait.emitter2 && _containerLandscape.emitter2) {
            _containerPortrait.emitter.emit = inVal;
            _containerLandscape.emitter.emit = inVal;
            _containerPortrait.emitter2.emit = inVal;
            _containerLandscape.emitter2.emit = inVal;
        }
    }
